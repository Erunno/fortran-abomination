...
contains
  ...
  subroutine CDWdiv(W2, U, V, W, dxmin, dymin, dzmin, Wnx, Wny, Wnz)
    ...
    !$acc parallel loop gang vector collapse(3) present(W2, U, V, W)
    do k = 2, Wnz + 1
      do j = 2, Wny + 1
        do i = 2, Wnx + 1
  ...
  subroutine CDWadv(W2, U, V, W, dxmin, dymin, dzmin, Wnx, Wny, Wnz)
    ...
    !$acc parallel loop gang vector collapse(3) private(Uadv, Vadv) present(W2, U, V, W)
    do k = 2, Wnz + 1
      do j = 2, Wny + 1
        do i = 2, Wnx + 1
  ...
  subroutine CDW(W2, U, V, W, dxmin, dymin, dzmin, Wnx, Wny, Wnz)
    ...
    !$acc data copyin(U, V, W) copyout(W2)
